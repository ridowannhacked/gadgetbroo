...
import type { PagesAnalyticsResult } from "@/lib/services/analyticsService"
...
export default function PagesAnalyticsClient({
  initialData,
}: {
  initialData: PagesAnalyticsResult
}) {
  ...
  const [data, setData] = useState<PagesAnalyticsResult | null>(initialData)
