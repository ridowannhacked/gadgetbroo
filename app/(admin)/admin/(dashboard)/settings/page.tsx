      ...
      <div className="bg-card border border-border rounded-xl p-6">
        ...
        <div className="mb-8 border-b border-border pb-8">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-muted hover:bg-secondary border border-border text-foreground rounded-lg transition text-sm"
            >
              <Upload size={16} />
              Upload Image
            </button>
        ...
        <div className="space-y-6 mb-8">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-background border border-border text-foreground rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500"
        ...
        <div>
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-2.5 rounded-lg font-medium transition-colors disabled:opacity-50"
          >
